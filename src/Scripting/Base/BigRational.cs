...
namespace Crockhead.Scripting
{
	...
	public struct BigRational : IEquatable<BigRational>
	{
		...
		/// 정수로 생성.
		/// </summary>
		public static BigRational FromInteger(long value)
		{
			return new BigRational(new BigInteger(value), BigInteger.One);
		}

		/// <summary>
		/// 문자열로 생성.
		/// </summary>
		public static BigRational ParseDecimal(string text)
		{
			...
			return new BigRational(numerator, scale);
		}
		...
		public static BigRational Remainder(BigRational a, BigRational b)
		{
			...
			return a - new BigRational(q, BigInteger.One) * b;
		}
